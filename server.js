...
async function fetchTranscriptPython(videoId) {
  return new Promise((resolve) => {
    ...
    const pyLines = [
        ...
        ' t = None',
        ' # Try manual EN captions first',
        ' try:',
        '  t = transcript_list.find_manually_created_transcript(["en","en-US","en-GB"]).fetch()',
        ' except Exception:',
        '  pass',
        ' # Fall back to auto-generated EN',
        ' if t is None:',
        '  try:',
        '   t = transcript_list.find_generated_transcript(["en","en-US","en-GB"]).fetch()',
        '  except Exception:',
        '   pass',
